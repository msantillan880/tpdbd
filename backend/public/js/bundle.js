...
/* harmony import */ var _models_Book_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./models/Book.js */ "./frontend/models/Book.js");
/* harmony import */ var _UI_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./UI.js */ "./frontend/UI.js");
...
document.addEventListener('DOMContentLoaded', () => {
  const ui = new _UI_js__WEBPACK_IMPORTED_MODULE_2__.default();
  ui.renderBooks();
});
...
document.getElementById('book-form')
  .addEventListener('submit', function(e) {
    ...
    // New Book Object
    const book = new _models_Book_js__WEBPACK_IMPORTED_MODULE_1__.default(title, author, isbn, comment);
...
/* harmony export */ });
class Book {
  constructor(title, author, isbn,comment) {
    this.title = title;
    this.author = author;
    this.isbn = isbn;
